...
<style>
  ...
  .input:focus, .textarea:focus { outline: none; border-color: var(--color-accent-primary); }
  ...
  .ms-input:focus { outline: none; border-color: var(--color-accent-primary); }
  ...
  .delete-btn.confirm { font-weight: 700; }
